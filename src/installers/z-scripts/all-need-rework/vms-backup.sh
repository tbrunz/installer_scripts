...
SOURCE_FOLDER=Virtual
TARGET_FOLDER=Virtual

EXTERN_LABEL=DATA

INTERN_HOME=/home/${USER_HOME}/${}
INTERN_WORK=/home/${USER_WORK}/${}

EXTERN_HOME=/media/${USER_HOME}/${EXTERN_LABEL}
EXTERN_WORK=/media/${USER_WORK}/${EXTERN_LABEL}
...
#
if   [[ -d ${INTERN_HOME} ]]; then SOURCE_LOCATION=${INTERN_HOME}

elif [[ -d ${EXTERN_WORK} ]]; then SOURCE_LOCATION=${INTERN_WORK}
else
...
#
if [[ -d ${EXTERN_HOME} ]]; then
    
    TARGET_LOCATION=${EXTERN_HOME}

elif [[ -d ${EXTERN_WORK} ]]; then 
    
    TARGET_LOCATION=${EXTERN_WORK}
