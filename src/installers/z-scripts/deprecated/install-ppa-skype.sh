...
#
# ----------------------------------------------------------------------------
# Install Microsoft Skype from repo
# ----------------------------------------------------------------------------
#
...
NOTE: This package installs Skype from the Canonical Partners repository.
"

SET_NAME="Microsoft Skype (PPA)"
PACKAGE_SET="skype  qt4-qtconfig
gtk2-engines-murrine:i386  gtk2-engines-pixbuf:i386  "

GetOSversion
REPO_NAME="${SET_NAME}"
REPO_URL="deb http://archive.canonical.com/ ${DISTRO} partner"
REPO_GREP="canonical.com.*${DISTRO}.*partner"
